...
public class AkunMahasiswa {
        ...
        btnupdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                try{
                    ...
                    stt.executeUpdate("UPDATE tb_mahasiswa SET nama_lengkap='"+nm+"',prodi='"+kp+"',angkatan='"+idang+"'," + "alamat='"+talam+"',status='"+stat+"' WHERE nim='"+nimm+"'"); JOptionPane.showMessageDialog(null, "Data Berhasil Diubah");
                    kosongmahasiswa();
                    tabelmahasiswa();
                }catch (SQLException e){
    ...
    protected void tabelmahasiswa(){
        Object[] barismahasiswa = {"NIM","NAMA","PRODI",
                "ANGKATAN","ALAMAT","STATUS"};
